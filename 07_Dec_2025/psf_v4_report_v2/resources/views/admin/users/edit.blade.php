...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group" >
                    {!! Form::label('pLable', 'Password*', ['class' => 'control-label']) !!}
                    {!! Form::password('password', ['class' => 'form-control', 'placeholder' => '','disabled'=>'']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('sites[]', $sites, $user->sites()->pluck('site', 'site'), ['class' => 'form-control select2', 'multiple' => 'multiple', 'required' => '','id'=>'sites']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('sites'))
                        <p class="help-block">
                            {{ $errors->first('sites') }}
