        ...
        {!! Form::open(['method' => 'POST', 'route' => ['admin.reporting.dashboard']]) !!}
            <div class="row">
                ...
                <div class="col-md-3 col-sm-12 form-group">
                    ...
                    {!! Form::label('FiscalYear', 'Fiscal Year', ['class' => 'control-label']) !!}     
                    {!! Form::checkbox('byMonth', $byMonth, old('byMonth'), ['class' => 'form-check-input','id'=>'byMonth',(($byMonth)? 'checked' : '')=> '', 'value' => '0']) !!}
                    {!! Form::label('byMonth', 'By Month', ['class' => 'control-label']) !!}     
                ...
                <div class="col-md-3 col-sm-12 form-group">
                    {!! Form::label('kp', trans('admin.kp') , ['class' => 'control-label']) !!}
                    {!! Form::select('kps[]', $kps, old('kps'), ['class' => 'form-control select2']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('kps'))
                        <p class="help-block">
                            {{ $errors->first('kp') }}
                ...
                <div class="col-md-3 col-sm-12 form-group">                  
                    ...
                    {!! Form::select('ages[]', $ages, old('ages'), ['class' => 'form-control select2']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('ages'))
                        <p class="help-block">
                            {{ $errors->first('age') }}
        ...
        <div class="panel-body table-responsive">
             ...
             <div class="row mb-4">
                <div class="col-md-12 col-sm-12">
                    <div style="width: 100%;margin: 0 auto; text-center">
                        @php
                            $DBController = new App\Http\Controllers\Dashboard_V3Controller();
                            
                            $DBController->locale = $locale;
                            $dataset = $DBController->getDataSet($filterPeriod,$isFiscalYear,$filtersites,$filterKp,$filterProvince,$filterAge);
                ...
                <div class="col-md-6">
                    <div style="width: 100%;margin: 0 auto;  background-color:white">
                        @php
                           ...
                           if ($dataset !=null)
                           {
                                //$chart = $DBController->SummaryParticipationChartByQ_V3($dataset, $filtersites, $monthReport,$isFiscalYear,$byMonth);
                              
                                $chart = $DBController->SummaryParticipationByPlatformChartByQ_V3($dataset, $filtersites, $monthReport,$isFiscalYear,$byMonth);
                ...
                <div class="col-md-6">
                    <div style="width:100%;margin: 0 auto; background-color:white">
                        ...
                        if ($dataset !=null)
                        {
                           ...
                           $chart = $DBController->SatisfactionWithProviderChart_V3($dataset,$filtersites, $monthReport,$isFiscalYear,$byMonth);
                            if ($chart !=null)
                            {
                                echo $chart->container();
                                echo $chart->script();
                    ...
                    <div style="width: 100%;margin: 0 auto; background-color:white">
                         @php
                            if ($dataset !=null)
                            {
                                ...
                                $chart = $DBController->PatientSatisfaction_V3($dataset,$filtersites, $monthReport,$isFiscalYear,$byMonth);
                                     if ($chart !=null)
                                    {
                                        echo $chart->container();
                                        echo $chart->script();
                    ...
                    <div style="width: 100%;margin: 0 auto; background-color:white">
                        @php
                            ...
                            if ($dataset !=null)
                           {
                                ...
                                $chart = $DBController->SatisfactionWithServiceChart_V3($dataset,$filtersites, $monthReport,$isFiscalYear,$byMonth);
                                        if ($chart !=null)
                                    {
                                        echo $chart->container();
                                        echo $chart->script();
                    ...
                    <div style="width: 100%;margin: 0 auto; background-color:white">
                       @php
                            ...
                            if ($dataset !=null)
                           {
                                ...
                                $chart = $DBController->ProviderAttitudeChart_V3($dataset,$filtersites, $monthReport,$isFiscalYear,$byMonth);
                    ...
                    <div style="width: 100%;margin: 0 auto; background-color:white">
                       @php
                            if ($dataset !=null)
                            {
                                ...
                                $chart = $DBController->PatientComments_V3($dataset,$filtersites, $monthReport,$isFiscalYear);
