            ...
            <ul class="navbar-nav ml-auto"​ id="navbarsExample09">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown09">
                        <a class="dropdown-item " href="/<?php echo e($parent); ?>/<?php echo e($token); ?>/en" ><span class="flag-icon flag-icon-en"> </span>  English</a>
                        <a class="dropdown-item " href="/<?php echo e($parent); ?>/<?php echo e($token); ?>/kh" ><span class="flag-icon flag-icon-kh"> </span>  ខ្មែរ</a>
                    </div>
                </li>
            </ul>
        </nav>
...
</html><?php /**PATH /Users/cheolsovandara/Documents/D/Developments/2026/psf_v4_report_v2/pfs_new/psf/resources/views/includes/header.blade.php ENDPATH**/ ?>