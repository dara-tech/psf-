...
class Dashboard_V3Controller extends Controller
{
    ...
    public function PatientComments_V3($dataset, $filtersites, $monthReport)
    {
        ...
        foreach( $dataset as $data)
        {
            ...
            if ( $data->Q6C_1 ==0 && ($data->Q6C_2 == 1 || $data->Q6C_3 == 1 || $data->Q6C_4 == 1 || $data->Q6C_5 == 1 || $data->Q6C_6 == 1 || $data->Q6C_7 == 1 || $data->Q6C_8 == 1))
            {
              $total++;
            }
        ...
        if ($total >0)
        {
          ...
          // $TotalCount =(object) array('label1'=>trans("patient.chart6_legend1"),'data'=>"".round($reduceWaitingtime/$total * 100 ) );
          $TotalCount =(object) array('label'=>trans("patient.chart6_legend1")." (".round($reduceWaitingtime/$total * 100)."%)",'data'=>"".round($reduceWaitingtime));
          array_push($data,$TotalCount);
          ...
          $TotalCount =(object) array('label'=>[trans("patient.chart6_legend2_1"),trans("patient.chart6_legend2_2")." (".round($moreFriendlyProvider/$total * 100)."%)"],'data'=>"".round($moreFriendlyProvider));
          array_push($data,$TotalCount);
          ...
          $TotalCount =(object) array('label'=>[trans("patient.chart6_legend3_1"),trans("patient.chart6_legend3_2")." (".round($staffPresent/$total * 100)."%)"],'data'=>"".round($staffPresent));
          array_push($data,$TotalCount);
          ...
          $TotalCount =(object) array('label'=>[trans("patient.chart6_legend4_1"),trans("patient.chart6_legend4_2")." (".round($staffFocusOnPatient/$total * 100)."%)"],'data'=>"".round($staffFocusOnPatient));
          array_push($data,$TotalCount);
          ...
          $TotalCount =(object) array('label'=>[trans("patient.chart6_legend5_1"), trans("patient.chart6_legend5_2")." (".round($cleanWaitingRoom/$total * 100)."%)"],'data'=>"".round($cleanWaitingRoom) );
          array_push($data,$TotalCount);
          ...
          $TotalCount =(object) array('label'=>[trans("patient.chart6_legend6_1"),trans("patient.chart6_legend6_2")." (".round($cleanToilet/$total * 100)."%)"],'data'=>"".round($cleanToilet));
          array_push($data,$TotalCount);
          ...
          $TotalCount =(object) array('label'=>[trans("patient.chart6_legend7_1"),trans("patient.chart6_legend7_2")." (".round($serviceEvery6month/$total * 100)."%)"],'data'=>"".round($serviceEvery6month));
          array_push($data,$TotalCount);
          // dd($reduceWaitingtime);
          // dd($total);
